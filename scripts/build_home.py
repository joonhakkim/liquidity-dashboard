...
SECTIONS = [
    ...
    ("포트폴리오 · 원자재", [
        ("troy_mp.html", "&#128181;", "MP 트래커 (트로이 · 모멘텀 · 코스닥 롱숏 2종)",
         "리서치팀 모델 포트폴리오 4종 - 롱온리(트로이 MP·모멘텀 MP)는 종목별 매수단가/수익률과 벤치마크 대비 초과성과를, 롱숏(코스닥 롱숏 개별종목·지수)은 NET EXPOSURE·MDD까지 추적. 페이지 안에서 네 포트폴리오를 탭으로 전환."),
