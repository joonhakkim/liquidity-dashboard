...
SECTIONS = [
    ...
    ("포트폴리오 · 원자재", [
        ("troy_mp.html", "&#128181;", "MP 트래커 (트로이 MP · 모멘텀 MP)",
         "리서치팀 모델 포트폴리오 2종 - 종목별 매수단가/수익률과 코스피 대비 초과성과(TWR 지수, 편입일=10,000)를 추적. 페이지 안에서 두 포트폴리오를 탭으로 전환."),
        ("kosdaq_long_short.html", "&#9878;", "코스닥 롱숏 MP (개별종목 · 지수)",
         "코스닥 종목 롱10/숏10 페어트레이드 모델 포트폴리오 2종(개별종목 숏 vs KODEX 코스닥150선물인버스 숏) - NET EXPOSURE·MDD·코스닥 대비 초과성과를 추적."),
